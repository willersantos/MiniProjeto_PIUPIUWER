...
function piu(){
    ...
    var caixaDeTextoPiu = input2.querySelector('textarea');
    caixaDeTextoPiu.addEventListener("input", function() {
            const quantidadeDeCaracteres = this.value.length;
...
function sombra2(opac,opac2,opac3){
    ...
    document.getElementById("Logo_PiuPiuwer").style.opacity=(opac*100)+"%";
    for(var i = 0; i < 8; i++){
        document.getElementsByTagName("li")[i].style.opacity=(opac*100)+"%";
    }
    document.getElementById("perfil").style.opacity=(opac*100)+"%";
    document.getElementById("capa").style.opacity=(opac*100)+"%";
    ...
    document.getElementById("user_identification").getElementsByTagName("img")[0].style.opacity=(opac*100)+"%";
